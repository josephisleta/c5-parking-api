...
class MPTest extends TestCase
{
    /** @var ParkingFee $parkingFee */
    private $parkingFee;

    const PARKING_SLOT_TYPE = 'MP';
    ...
    public function testClass()
    {
        ...
        $this->assertInstanceOf('Concrete\Package\ParkingApi\Src\Domain\ParkingFee\Types\MP', $this->parkingFee);
    }
